...
class SourceResponse {
  SourceResponse({
      this.status, 
      this.sources,
      this.code,//hzwd al hala ale feha error
       this.message,//hzwd al hala ale feha error
  });

  SourceResponse.fromJson(dynamic json) {
    status = json['status'];
    message =json["message"];//hzwd al hala ale feha error
    code =json["code"];//hzwd al hala ale feha error
  ...
  //variable
  String? status;
  String? code; //hzwd al hala ale feha error
  String? message;//hzwd al hala ale feha error
  List<Source>? sources;
